...
import com.example.schoolproject.Adapter.CapatainChatpage;
...
public class CaptainChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterChat = new CapatainChatpage(CaptainChatActivity.this, chatList);
...
//                }
                if(!message.equals("")){
                    ...
                    Toast.makeText(CaptainChatActivity.this, "Can not send empty message...", Toast.LENGTH_SHORT).show();
                }

                messageEt.setText("");
//                if (message.equals("Can I have a match with you")){
//                    messageEt.setOnClickListener(new View.OnClickListener() {
//                        @Override
//                        public void onClick(View v) {
//                            Intent intent = new Intent(CaptainChatActivity.this, SetMatch.class);

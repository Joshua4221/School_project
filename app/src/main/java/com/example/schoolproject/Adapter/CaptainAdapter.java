...
import com.example.schoolproject.CaptainChatActivity;
...
public class CaptainAdapter extends RecyclerView.Adapter<CaptainAdapter.MyHolder> {

    Context context;
    List<User> userList;

    public CaptainAdapter(Context context, List<User> userList) {
        this.context = context;
        this.userList = userList;
    }

    @Override
    public @NotNull CaptainAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_users, parent, false);
        return new CaptainAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull CaptainAdapter.MyHolder holder, int position) {
...
//        User user = userList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, CaptainChatActivity.class);
